...
*@param key - Key
*/
int FindNumberByKey(list_t* p, int key);

/*
*@brief Count the number of elements
*@param p - List pointer
*/
int QuantityItems(list_t* p);
...
*@param n - Item number
*/
list_t* DeleteItem(list_t* p, int n);
...
*@param key - Key
*/
int Iteration(list_t* p, int key);
